...
// pages
import formationSection from '../components/jackpot/formationSection.vue'
import standingsSection from '../components/jackpot/standingsSection.vue'
import tipsSection from '../components/jackpot/tipsSection.vue'
...
const activePage = shallowRef(formationSection)
